  ...
  return (
    <aside className="oc-sidebar">
      ...
      <nav className="oc-nav">
        ...
        <Link href="/sales" className={`oc-navlink ${isActive('/sales')}`}>Sales</Link>
        <Link href="/student-bank/admin" className={`oc-navlink ${isActive('/student-bank/admin')}`}>Student Bank</Link>
        ...
        <Link href="/settings/landing-videos" className={`oc-navlink ${isActive('/settings/landing-videos')}`}>Landing Videos</Link>
      </nav>
    </aside>
  );
}
